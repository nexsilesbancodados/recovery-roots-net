...
const GlowCard: React.FC<GlowCardProps> = ({ 
  ...
  const getInlineStyles = (): React.CSSProperties & Record<string, string | number> => {
    const baseStyles: React.CSSProperties & Record<string, string | number> = {
      ...
      '--backup-border': 'hsl(160 40% 70% / 0.4)',
      '--size': '300',
      '--outer': '1',
      '--saturation': '80',
      '--lightness': '60',
      ...
      backgroundImage: `radial-gradient(
        ...
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsl(var(--hue, 160) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 70) * 1%) / var(--bg-spot-opacity, 0.15)), transparent
      )`,
  ...
  const beforeAfterStyles = `
    ...
    [data-glow]::before {
      background-image: radial-gradient(
        ...
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsl(var(--hue, 160) 80% 50% / 1), transparent 100%
      );
    ...
    [data-glow] > [data-glow]::before {
      ...
      background-image: radial-gradient(
        ...
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsl(var(--hue, 160) 100% 60% / 0.8), transparent 100%
      );
    }
  `;
