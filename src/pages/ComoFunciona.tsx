...
const ComoFunciona = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title={"Como Funciona a Internação "} description={" Hospital Rumo Certo|Entenda as etapas da internação: do primeiro contato à alta, com suporte completo."} path={"/como-funciona"} />
      <EmergencyBar />
      <Navbar />
